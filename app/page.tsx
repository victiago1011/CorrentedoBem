    ...
    <div className="min-h-screen bg-[#fcf9f8] text-[#1b1c1c] font-body selection:bg-[#00628c]/20 selection:text-[#00628c]">
      ...
      <header className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-[#bec8d1]/20">
        <nav className="flex justify-between items-center px-8 py-4 max-w-7xl mx-auto">
          <Link href="/" className="text-2xl font-bold text-[#00628c] tracking-tighter font-headline">
            Corrente do Bem
          </Link>
          <div className="hidden md:flex items-center space-x-8 text-sm font-semibold tracking-tight">
            <Link href="/admin" className="text-[#3e4850] hover:text-[#00628c] transition-colors duration-200">Buscar Vagas</Link>
            <Link href="/admin" className="text-[#3e4850] hover:text-[#00628c] transition-colors duration-200">Encontrar Talentos</Link>
          ...
          <div className="flex items-center space-x-4">
            <Link href="/admin" className="px-5 py-2 text-sm font-semibold text-[#00628c] hover:bg-[#f6f3f2] rounded-full transition-all">
              Entrar
            </Link>
            <Link href="/admin" className="px-5 py-2 text-sm font-semibold bg-[#00628c] text-white rounded-full shadow-sm hover:scale-95 transition-transform duration-150">
              Cadastrar-se
            </Link>
          </div>
        </nav>
      ...
      <main>
        {/* Hero Section */}
        <section className="relative min-h-[800px] flex items-center overflow-hidden bg-[#fcf9f8] pt-20">
          <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <motion.div 
              ...
              className="space-y-8"
            >
              <span className="inline-block px-4 py-1.5 bg-[#bff444] text-[#141f00] font-bold text-xs rounded-full tracking-wider uppercase">
                Dignidade e Conexão
              </span>
              <h1 className="text-5xl lg:text-7xl font-extrabold text-[#1b1c1c] leading-[1.1] tracking-tight font-headline">
                Encontre sua próxima <span className="text-[#00628c]">oportunidade</span> ou ofereça ajuda
              </h1>
              <p className="text-xl text-[#3e4850] max-w-lg leading-relaxed">
                Unindo talentos invisíveis a empresas que valorizam o impacto social. Construa carreiras, transforme realidades.
              </p>
              <div className="bg-white p-2 rounded-2xl shadow-xl shadow-[#00628c]/5 flex flex-col md:flex-row gap-2 max-w-2xl border border-[#bec8d1]/20">
                <div className="flex-1 flex items-center px-4 gap-3 bg-[#f6f3f2] rounded-xl">
                  <Search className="w-5 h-5 text-[#6f7881]" />
                  <input 
                    className="w-full bg-transparent border-none focus:ring-0 py-4 text-[#1b1c1c] placeholder-[#6f7881]" 
        ...
        <section className="py-24 bg-[#f6f3f2]">
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div>
                <h2 className="text-4xl font-bold text-[#1b1c1c] tracking-tight mb-4 font-headline">Destaques do Dia</h2>
                <p className="text-[#3e4850] text-lg max-w-2xl">Oportunidades que precisam do seu talento hoje. Aplique agora e mude sua trajetória.</p>
              </div>
              <Link className="group flex items-center gap-2 text-[#00628c] font-bold hover:gap-4 transition-all" href="/admin">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              <div className="md:col-span-2 lg:col-span-2 bg-white p-8 rounded-3xl transition-all hover:shadow-xl hover:-translate-y-1 border border-[#bec8d1]/10">
                ...
                <Link href="/admin" className="block w-full py-4 bg-[#f0eded] text-[#1b1c1c] font-bold rounded-xl hover:bg-[#00628c] hover:text-white transition-colors text-center">
                  Candidatar-se
                </Link>
              </div>
              {/* Job Card 2 */}
              <div className="bg-white p-8 rounded-3xl transition-all hover:shadow-xl hover:-translate-y-1 border border-[#bec8d1]/10">
                ...
                <Link href="/admin" className="block w-full py-3 bg-[#f0eded] text-[#1b1c1c] font-bold rounded-xl hover:bg-[#00628c] hover:text-white transition-colors text-center">
                  Detalhes
                </Link>
              </div>
              {/* Job Card 3 */}
        ...
        <section id="comunidade" className="py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex items-center gap-4 mb-4">
              <div className="h-px flex-1 bg-[#bec8d1]/30"></div>
              <span className="text-[#964900] font-bold tracking-widest uppercase text-xs">Comunidade</span>
              <div className="h-px flex-1 bg-[#bec8d1]/30"></div>
            </div>
            <h2 className="text-4xl font-bold text-[#1b1c1c] text-center mb-16 tracking-tight font-headline">Talentos que Inspiram</h2>
            ...
            <div className="mt-16 flex justify-center">
              <Link className="inline-flex items-center gap-2 px-8 py-4 bg-[#00628c] hover:bg-[#004c6d] text-white font-bold rounded-lg transition-all hover:scale-105 shadow-sm group" href="/admin">
        ...
        {/* Como Funciona */}
        <section id="como-funciona" className="py-24 bg-[#f0eded]">
          <div className="max-w-7xl mx-auto px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="text-4xl font-extrabold text-[#1b1c1c] tracking-tight mb-8 font-headline">Como Funciona</h2>
                {/* Tabs */}
                <div className="flex gap-6 mb-12 border-b border-[#bec8d1]/30">
                  <button 
                    onClick={() => setActiveTab('candidatos')}
                    className={`pb-4 font-bold transition-all ${activeTab === 'candidatos' ? 'text-[#00628c] border-b-2 border-[#00628c]' : 'text-[#3e4850] hover:text-[#1b1c1c]'}`}
                  >
                    Para Candidatos
                  </button>
                  <button 
                    onClick={() => setActiveTab('empresas')}
                    className={`pb-4 font-bold transition-all ${activeTab === 'empresas' ? 'text-[#00628c] border-b-2 border-[#00628c]' : 'text-[#3e4850] hover:text-[#1b1c1c]'}`}
                  >
                    Para Empresas
                  </button>
                </div>
        ...
        <section id="comunidade" className="py-24 bg-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-8">
            <h2 className="text-4xl font-bold text-[#1b1c1c] text-center mb-20 tracking-tight font-headline">Depoimentos da Comunidade</h2>
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-8">
            <div className="bg-gradient-to-r from-[#00628c] to-[#007cb0] rounded-[3.5rem] p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-[#00628c]/30">
              <div className="relative z-10 max-w-3xl mx-auto">
                <h2 className="text-4xl lg:text-5xl font-extrabold mb-6 font-headline">Pronto para fazer parte desta corrente?</h2>
                <p className="text-lg opacity-90 mb-10 leading-relaxed">Seja você um profissional em busca de espaço ou uma empresa querendo transformar vidas, seu lugar é aqui.</p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/admin" className="bg-white text-[#00628c] px-10 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-transform shadow-lg">
                    Cadastrar Currículo
                  </Link>
                  <Link href="/admin" className="bg-[#bff444] text-[#141f00] px-10 py-4 rounded-2xl font-bold text-lg hover:scale-105 transition-transform shadow-lg">
                    Anunciar uma Vaga
                  </Link>
                </div>
              </div>
      ...
      {/* Footer */}
      <footer className="bg-[#f6f3f2] border-t border-[#bec8d1]/20 py-16 px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 max-w-7xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Sobre Nós</Link></li>
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Histórias de Sucesso</Link></li>
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Relatório de Impacto 2024</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-[#00628c] mb-6 uppercase text-xs tracking-widest">Suporte</h4>
            <ul className="space-y-4 text-sm">
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Central de Ajuda</Link></li>
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Termos de Uso</Link></li>
              <li><Link className="text-[#3e4850] hover:text-[#00628c] transition-colors" href="/admin">Privacidade</Link></li>
            </ul>
          </div>
          <div>
